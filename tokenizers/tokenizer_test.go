...
func TestJiebaTokenizerDefaultModeWithHMM(t *testing.T) {
	...
	tokenizer, _ := NewJiebaTokenizer("../embed/dict.txt", true, false)
...
func TestJiebaTokenizerSearchModeWithHMM(t *testing.T) {
	...
	tokenizer, _ := NewJiebaTokenizer("../embed/dict.txt", true, true)
	for _, test := range tests {
		actual := tokenizer.Tokenize(test.input)
		if !reflect.DeepEqual(actual, test.output) {
			t.Errorf("Expected %v, got %v for %s", test.output, actual, string(test.input))
...
func TestJiebaTokenizerDefaultModeWithoutHMM(t *testing.T) {
	...
	tokenizer, _ := NewJiebaTokenizer("../embed/dict.txt", false, false)
	for _, test := range tests {
		actual := tokenizer.Tokenize(test.input)
		if !reflect.DeepEqual(actual, test.output) {
			t.Errorf("Expected %v, got %v for %s", test.output, actual, string(test.input))
...
func TestJiebaTokenizerSearchModeWithoutHMM(t *testing.T) {
	...
	tokenizer, _ := NewJiebaTokenizer("../embed/dict.txt", false, true)
	for _, test := range tests {
		actual := tokenizer.Tokenize(test.input)
		if !reflect.DeepEqual(actual, test.output) {
